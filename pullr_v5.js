// Pullr Intel Vibrant Project 2012 Greg Dorsainville, Stepan Boltalin, Alexander kozovski
//Helped by code from  Brian Chirls, Chris Allick, and Clea Barnett
// this version is refactored and streamlined from the functional pullr_v4 (fallback for demo with skipping issue). 
...
function getYoutubeInfoArray (video) { 
    ...
    var timeCodeSeconds = 60*(Number(timeCodeSecondsString[0])) + (Number(timeCodeSecondsString[1])); //the minutes are converted to seconds 
